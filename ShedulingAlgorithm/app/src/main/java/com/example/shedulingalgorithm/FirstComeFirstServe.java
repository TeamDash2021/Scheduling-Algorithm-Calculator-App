...
public class FirstComeFirstServe extends AppCompatActivity {
    ...
    Button solve;
    //ValuesForCalculation values[];
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_first_come_first_serve);
        ...
        solve.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(FirstComeFirstServe.this, "chalra", Toast.LENGTH_SHORT).show();
                String v = numberOfProcesses.getText().toString();
                int nofp = 0;
                ...
                for(int i =0;i<nofp;i++)
                {
                    ...
                    values.add(vd);
                    //values[i].setProcessName(p.get(i).getText().toString());
                    //values[i].setArrivalTime(Double.parseDouble(a.get(i).getText().toString()));
                    //values[i].setArrivalTime(Double.parseDouble(b.get(i).getText().toString()));
                }
                if(numberOfProcesses.getText().toString().trim().isEmpty() == false && count==0){
                    Intent intent = new Intent(FirstComeFirstServe.this,FirstComeFirstServeSolution.class);
