...
public class ShortestJobFirst extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shortest_job_first);
        ...
        solve.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(numberOfProcesses.getText().toString().trim().isEmpty() == false && count==0){
                    Intent intent = new Intent(ShortestJobFirst.this,FirstComeFirstServeSolution.class);
